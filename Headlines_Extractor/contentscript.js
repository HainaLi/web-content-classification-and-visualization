...
for (var i=0; i <all_page_nodes.length; i++) {
	...
	if (innerT.toLowerCase().indexOf("sponsored") !== -1) { //rule out advertisements
		continue
	}
...
function get_topic(id) {
	var topic_lookup = ["Atheism", "Computer", "Computer", "Computer", "Computer", "Computer", "For Sale", "Automobiles", "Motorcycles", "Baseball", "Hockey", "Cryptography", "Electronics", "Medicine", "Outer Space", "Christianity", "Politics", "Politics", "Politics", "Religion"]
